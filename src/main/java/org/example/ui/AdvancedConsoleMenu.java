...
public class AdvancedConsoleMenu implements ConsoleMenu {
  ...
  public AdvancedConsoleMenu(BookService books, ReaderService readers, RegistryService registry) {
    this.books = books;
  ...
  protected void handleOption(String option) throws RuntimeException {
    switch (option) {
